...
public class GJDepthFirst2<R,A> implements GJVisitor<R,A> {
 ...
 void spillatinterval(List<liveness> liverange,int i,List<liveness> active,HashMap<Integer, allocation> mappings,List<String> registerpool){
	 int j;
 ...
 int linear_scan(List<liveness> liverange,int size, HashMap<Integer, allocation> mappings){
...
return numspilled;	 
   ...
   public R visit(Goal n, A argu) {
    ...
    spilltobereported+= linear_scan(liverange,siz,mappings);  
   ...
   public R visit(Procedure n, A argu) {
    ...
    spilltobereported+= linear_scan(liverange,size,mappings);  
    registerallocation.put(funcName, mappings);
    spillallocatedforfunc.put(funcName, spilledallocated);
